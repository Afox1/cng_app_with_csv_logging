...
st.title("🚗 AI-Powered CNG Maintenance & Safety Reminder with PDF Report & Logging")
...
def log_user_data():
    headers = [
        "Date", "Vehicle", "LastServiceKM", "CurrentKM", "ServiceInterval", "DaysSinceService",
        "MaintenanceResult", "PredictedNextKM", "Hissing", "SmellRating", "CheckEngine",
        "MileageDrop", "Backfiring", "RiskAssessment"
    ]
    row = [
